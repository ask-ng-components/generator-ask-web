...
module.exports = generators.Base.extend({
  ...
  configuring: {
    ...
    saveOtherProps: function () {
      this.config.set('wiredepExclusions', this.wiredepExclusions);
      this.config.set('appName', this.appName);
      this.config.set('imageMin', this.imageMin);
      this.config.set('watchTaskDeps', this.watchTaskDeps);
      this.config.set('processedFileExtension', this.processedFileExtension);
    }
  }, // end configuring
